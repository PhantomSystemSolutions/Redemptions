...
| fshop {Item Name} {Quantity} | If {Quantity} of {Item Name} is available, purchases the Item. Each Item has it's own Limits to purchasing. |
...
| fshop reset | Broadcaster-only Command. This will reset all Shop Item that have had purchases made. | 
